...
- Edits > 500 lines/call, or files outside `d:\AI process\Machine Learning\`.
- Training/download > 30s wall-time.
- Dataset download > 100MB, or any write/delete inside `data/`.

## 2. Project Context

- **Root:** `d:\AI process\Machine Learning\`
...
- **Memory:** persistent memory at `C:\Users\Admin\.claude\projects\d--AI-process-Machine-Learning\memory\`. Save user / feedback / project / reference per the auto-memory system. Do NOT save things derivable from code (patterns, paths, git history).
