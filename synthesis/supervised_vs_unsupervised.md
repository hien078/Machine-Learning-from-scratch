...
|---|---|---|---|
| [01 Linear Regression](../topics/01_linear_regression/README.md) | Supervised | Real-valued $y$ | MSE |
| [02 Gradient Descent](../topics/02_gradient_descent/README.md) | — (optimizer, paradigm-agnostic) | Any differentiable loss | Loss minimization |
| [03 Regularization](../topics/03_regularization/README.md) | — (objective modifier) | Any loss + penalty | Loss $+\lambda\,\Omega(w)$ |
| [04 Logistic Regression](../topics/04_logistic_regression/README.md) | Supervised | Class label | Binary cross-entropy |
| [05 Decision Tree](../topics/05_decision_tree/README.md) | Supervised | Class label / real $y$ | Impurity reduction |
| [06 Ensemble Methods](../topics/06_ensemble_methods/README.md) | Supervised | Class label / real $y$ | Aggregated base-learner loss |
| [07 KNN](../topics/07_knn/README.md) | Supervised | Class label / real $y$ | None (memorize; vote at query) |
| [08 Naive Bayes](../topics/08_naive_bayes/README.md) | Supervised (generative) | Class label | Joint likelihood $p(x,y)$ |
| [09 SVM](../topics/09_svm/README.md) | Supervised | Class label $y\in\lbrace-1,+1\rbrace$ | Hinge loss + margin |
| [10 PCA](../topics/10_pca/README.md) | Unsupervised | None | Variance / reconstruction error |
| [11 Clustering](../topics/11_clustering/README.md) | Unsupervised | None | Distortion (K-Means), likelihood (GMM) |
| [12 Dimensionality Reduction](../topics/12_dimensionality_reduction/README.md) | Unsupervised | None | Neighborhood preservation |
| [13 Neural Networks](../topics/13_neural_networks/README.md) | Supervised (architecture is paradigm-agnostic) | Class label / real $y$ | Cross-entropy / MSE |
| [14 CNN](../topics/14_cnn/README.md) | Supervised (architecture) | Class label | Cross-entropy |
| [15 RNN/LSTM](../topics/15_rnn_lstm/README.md) | Supervised / self-supervised | Next element of the sequence | Sequence cross-entropy |
| [16 Transformer](../topics/16_transformer/README.md) | Self-supervised (pretrain) + supervised (fine-tune) | Next/masked token | Cross-entropy |
| [17 Autoencoder](../topics/17_autoencoder/README.md) | Self-supervised (input is its own target) | $x$ itself | Reconstruction; $-\mathrm{ELBO}$ (VAE) |
| [18 Reinforcement Learning](../topics/18_reinforcement_learning/README.md) | Reinforcement | Reward $r_t$ | Expected return |
| [19 Generative Models](../topics/19_generative_models/README.md) | Unsupervised / self-supervised | None ($x$ only) | Likelihood, ELBO, adversarial, denoising |
| [20 Graph Neural Networks](../topics/20_graph_neural_networks/README.md) | Supervised (also SSL pretraining) | Node/graph labels | Cross-entropy over graph structure |
| [21 LLM Engineering](../topics/21_llm_engineering/README.md) | All four in one pipeline | Tokens → preferences → rewards | CE pretrain, supervised fine-tune, RLHF |
| [22 Self-Supervised Learning](../topics/22_self_supervised_learning/README.md) | Self-supervised | Constructed pretext targets | InfoNCE, masked prediction |
...
- **Reconstruction is prediction with $y:=x$.** The autoencoder objective
  $\Vert x-g(f(x))\Vert_2^2$ is [Topic 01](../topics/01_linear_regression/theory.md)'s
...
```
  ...
  augmentation ([22 Self-Supervised Learning](../topics/22_self_supervised_learning/theory.md)).
  Likewise, a language model is "just" a classifier over the vocabulary whose labels
  come free from the corpus ([16 Transformer](../topics/16_transformer/theory.md)).
...
- **Pretrain, then fine-tune** — the dominant modern form: self-supervised pretraining
  ...
  ([21 LLM Engineering](../topics/21_llm_engineering/README.md)).
...
- **Topics:** [10 PCA](../topics/10_pca/README.md), [11 Clustering](../topics/11_clustering/README.md), [12 Dimensionality Reduction](../topics/12_dimensionality_reduction/README.md), [17 Autoencoder](../topics/17_autoencoder/README.md), [18 Reinforcement Learning](../topics/18_reinforcement_learning/README.md), [22 Self-Supervised Learning](../topics/22_self_supervised_learning/README.md)
