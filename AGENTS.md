...
> **Mirror of [CLAUDE.md](CLAUDE.md).** §1–§10 are byte-for-byte identical between the two files; §11 is tool-specific (Antigravity here, Claude Code there). **When updating shared rules, edit both files.**
