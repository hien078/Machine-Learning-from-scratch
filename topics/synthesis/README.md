...
These documents connect ideas across multiple topics. They answer questions like:
- When should I use model A vs model B?
- How do loss functions relate across models?
- What's the geometric view of ML?

## Documents

| Document | Connects |
|---|---|
| [optimization_methods_compared.md](optimization_methods_compared.md) | GD, Newton, closed-form across models |
| [loss_functions_map.md](loss_functions_map.md) | MSE, CE, hinge, log-loss |
| [bias_variance_tradeoff.md](bias_variance_tradeoff.md) | Fundamental tradeoff across all models |
| [geometry_of_ml.md](geometry_of_ml.md) | Geometric view: regression, PCA, SVM |
| [probabilistic_view_of_ml.md](probabilistic_view_of_ml.md) | MLE, MAP, Bayesian connections |
