...
| 2 | `first_principles.ipynb` | Computation | From-scratch GD, momentum, Adam; learning rate effects; convergence race; library comparison |
| 3 | `exercises.ipynb` | Practice | Hand-calc GD steps, implement momentum GD, conceptual questions on Adam vs SGD |
